...
canvas.plot_data_normal(data2plot, var_names, args.directory, f"{args.plotname}.pdf", contrast=True,
                    cvalues=(Datamin, Datamax))

#canvas.plot_data_normal(data2plot[3:4], [('t2m', 'K'),('t2m', 'K'),('t2m', 'K')], args.directory, f"{args.plotname}_diff.pdf", contrast=True,
#                    cvalues=((-4.0,-4.0,-3.0), (4.0,4.0,3.0)))

var_names = [('ff', 'm/s'), ('t2m', 'K')]
canvas.plot_data_ff_t2m(data2plot, var_names, args.directory, f"{args.plotname}_fft2m.pdf", contrast=False,
                   )